...
public class BakingDateTest {
    ...
    public void applyBasicTest() {
        Date testValue = new BakingDate().apply(
                TestPojoClass.TEST_CLASS_FIELDS.get(TestPojoClass.ANNOTATED_TEST_DATE_FIELD), // passing annotated field
    ...
    public void shouldBeTrimmedTest() {
        Date testValue = new BakingDate().apply(
                TestPojoClass.TEST_CLASS_FIELDS.get(TestPojoClass.ANNOTATED_TEST_DATE_FIELD),
                "           01-01-2000         "
        );
    ...
    public void timestampValueTest() {
        Date testValue = new BakingDate().apply(
                TestPojoClass.TEST_CLASS_FIELDS.get(TestPojoClass.NOT_ANNOTATED_TEST_DATE_FIELD),
    ...
    private static Date expectedDate() {
        return new SimpleDateFormat(TestPojoClass.DD_MM_YYYY).parse(STRING_FOR_01_01_2000);
    }
